...
function AdminProjectUpdatePage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      showToast(e.response?.data?.message || "Failed to add update", "error");
    ...
    <>
      ...
      <div className="page">
        ...
        <div className="page-header">
          <div>
            <p className="page-overline">Project Management</p>
            <h1 className="page-title">Post Update</h1>
            <p className="page-sub">Share progress with your donors</p>
          </div>
            ...
            <div className="preview-body">
              <div className="update-card">
                ...
                <h3 className="update-card-title">
                  {title || <span style={{ color: "#ccc", fontStyle: "italic" }}>Update title…</span>}
                </h3>
                <p className="update-card-desc">
                  {description || <span style={{ color: "#ddd", fontSize: 13 }}>Description will appear here…</span>}
                </p>
                ...
                <div className="update-card-footer">
                  <span>📋 By Admin</span>
                  <span>{previews.length > 0 ? `${previews.length} image${previews.length > 1 ? "s" : ""}` : "No images"}</span>
                </div>
              </div>
            </div>
          </div>
...
const styles = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .btn--primary {
    background: var(--gold); color: #080f1e;
  ...
  .btn-spinner {
    ...
    border: 2px solid rgba(0,0,0,0.2); border-top-color: #080f1e;
  ...
  .update-date { font-size: 11.5px; color: var(--muted-light); font-weight: 500; }
  .update-card-title {
    font-family: 'Cormorant Garamond', serif;
    font-size: 20px; font-weight: 700; color: var(--navy);
